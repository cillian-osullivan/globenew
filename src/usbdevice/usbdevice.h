...
#ifndef GLOBE_USBDEVICE_USBDEVICE_H
#define GLOBE_USBDEVICE_USBDEVICE_H
...
public:
    ...
    bool IsGlobeVersion() const override { return txTo && txTo->IsGlobeVersion(); }
...
#endif // GLOBE_USBDEVICE_USBDEVICE_H
