...
public:
    ...
    void Unserialize(Stream& s) {
        ...
        m_stake_type = globe::ToTxoutType(stake_type);
        m_stake_id.SetNull();
        ...
        m_spend_type = globe::ToTxoutType(spend_type);
        m_spend_id.SetNull();
