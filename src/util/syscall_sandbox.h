...
#ifndef GLOBE_UTIL_SYSCALL_SANDBOX_H
#define GLOBE_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during globed initialization if Globe Core was compiled
...
#endif // GLOBE_UTIL_SYSCALL_SANDBOX_H
