...
public:
    ...
    void setGlobeTokenExec(GlobeTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strGlobeAddress, std::string& strHash160);
    static bool ToGlobeAddress(const std::string& strHash160, std::string& strGlobeAddress);
...
private:
    ...
    GlobeToken(GlobeToken const&);
    GlobeToken& operator=(GlobeToken const&);
