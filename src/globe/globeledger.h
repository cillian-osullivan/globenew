#ifndef GLOBELEDGER_H
#define GLOBELEDGER_H
...
/**
 * @brief The GlobeLedger class Communicate with the globe ledger
 */
class GlobeLedger {
    
public:
    /**
     * @brief GlobeLedger Constructor
     */
    GlobeLedger();

    /**
     * @brief ~GlobeLedger Destructor
     */
    virtual ~GlobeLedger();
...
private:
    GlobeLedger(const GlobeLedger&);
    GlobeLedger& operator=(const GlobeLedger&);
    GlobeLedgerPriv* d;
};
#endif
