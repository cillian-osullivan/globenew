...
#ifndef GLOBE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define GLOBE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // GLOBE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
