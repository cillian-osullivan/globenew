...
BOOST_AUTO_TEST_CASE(frozen_blinded_test)
{
    ...
    int peer_blocks = globe::GetNumBlocksOfPeers();
    globe::SetNumBlocksOfPeers(0);
    ...
    BOOST_CHECK(blockbalances.plain() == globe::GetUTXOSum(chainstate_active));
    ...
    CAmount utxo_sum_before_fork = globe::GetUTXOSum(chainstate_active);
    ...
    CAmount utxo_sum_after_fork = globe::GetUTXOSum(chainstate_active);
    ...
    BOOST_REQUIRE(globe::GetUTXOSum(chainstate_active) == moneysupply_before_post_fork_to_blinded);
    ...
    CAmount utxosum = globe::GetUTXOSum(chainstate_active);
    ...
    globe::SetNumBlocksOfPeers(peer_blocks);
}
