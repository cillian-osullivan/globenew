...
#ifndef GLOBE_WALLET_WALLETUTIL_H
#define GLOBE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! globe from opening the wallet, thinking it was newly created, and
...
#endif // GLOBE_WALLET_WALLETUTIL_H
