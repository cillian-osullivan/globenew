...
#ifndef GLOBE_CRYPTO_CHACHA_POLY_AEAD_H
#define GLOBE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@globe.
 *
 ...
 *
 * The chacha20-poly1305@globe combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@globe cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@globe are relatively fast in
...
#endif // GLOBE_CRYPTO_CHACHA_POLY_AEAD_H
