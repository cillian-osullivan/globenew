// Copyright (c) 2014-2019 The Globe Core developers
...
#if defined(__linux__) && defined(ENABLE_ARM_SHANI) && !defined(BUILD_GLOBE_INTERNAL)
#include <sys/auxv.h>
#include <asm/hwcap.h>
#endif

#if defined(MAC_OSX) && defined(ENABLE_ARM_SHANI) && !defined(BUILD_GLOBE_INTERNAL)
#include <sys/types.h>
...
std::string SHA256AutoDetect()
{
...
#if defined(ENABLE_X86_SHANI) && !defined(BUILD_GLOBE_INTERNAL)
    if (have_x86_shani) {
    ...
    if (have_sse4) {
        ...
        ret = "sse4(1way)";
#endif
#if defined(ENABLE_SSE41) && !defined(BUILD_GLOBE_INTERNAL)
        TransformD64_4way = sha256d64_sse41::Transform_4way;
        ret += ",sse41(4way)";
#endif
    }

#if defined(ENABLE_AVX2) && !defined(BUILD_GLOBE_INTERNAL)
...
#if defined(ENABLE_ARM_SHANI) && !defined(BUILD_GLOBE_INTERNAL)
