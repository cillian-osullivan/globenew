...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The globe address to validate"},
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR, "address", /* optional */ true, "The globe address validated"},
                ...
                {RPCResult::Type::STR, "stakeonly_address", /* optional */ true, "The globe address encoded as a stakeonly_address"},
