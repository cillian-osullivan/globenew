...
#ifndef GLOBE_NODE_CONNECTION_TYPES_H
#define GLOBE_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/globe-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Globe’s Peer-to-Peer Network")
...
#endif // GLOBE_NODE_CONNECTION_TYPES_H
