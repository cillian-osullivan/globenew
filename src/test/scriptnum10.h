...
#ifndef GLOBE_TEST_SCRIPTNUM10_H
#define GLOBE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Globe Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GLOBE_TEST_SCRIPTNUM10_H
