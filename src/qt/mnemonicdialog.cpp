...
void MnemonicDialog::on_btnImport_clicked()
{
    ...
    QString sPassword = GUIUtil::globe::escapeQString(ui->edtPassword->text());
...
void MnemonicDialog::on_btnImportFromHwd_clicked()
{
    ...
    m_thread->setObjectName("globe-hwImport");
    m_thread->start();
...
#endif
#endif
            ui->tbxHwdOut->appendPlainText("The Globe app on your device must be open before importing.");
        }
    } else {
        UniValue rv;
