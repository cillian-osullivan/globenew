...
#ifndef GLOBE_QT_GLOBEGUI_H
#define GLOBE_QT_GLOBEGUI_H
...
/**
  Globe GUI main class. This class represents the main window of the Globe UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GlobeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GlobeGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GlobeGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a globe wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, GlobeUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Globe Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(GlobeUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // GLOBE_QT_GLOBEGUI_H
