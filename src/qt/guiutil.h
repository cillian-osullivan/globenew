...
#ifndef GLOBE_QT_GUIUTIL_H
#define GLOBE_QT_GUIUTIL_H
...
/** Utility functions used by the Globe Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "globe:" URI into recipient object, return true on successful parsing
