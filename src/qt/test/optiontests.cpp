...
{
    // Test regression https://github.com/globe/globe/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/globe-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/globe-core/gui/pull/568.
    // With fListen=false in ~/.config/Globe/Globe-Qt.conf and all else left as default,
    // globe-qt should set both -listen and -listenonion to false and start successfully.
