...
CTransactionRef CreateTxn(CHDWallet *pwallet, CGlobeAddress &address, CAmount amount, int type_in, int type_out, int nRingSize = 5)
{
...
static void AddAnonTxn(CHDWallet *pwallet, CGlobeAddress &address, CAmount amount, OutputTypes output_type)
{
    {
    LOCK(pwallet->cs_wallet);
...
static void AddTx(benchmark::Bench& bench, const std::string from, const std::string to, const bool owned)
{
    ...
    CGlobeAddress addr_a(part::StripQuotes(rv.write()));

    rv = CallRPC(to_address_type, context, "b");
    CGlobeAddress addr_b(part::StripQuotes(rv.write()));
...
static void GlobeAddTxPlainPlainNotOwned(benchmark::Bench& bench) { AddTx(bench, "plain", "plain", false); }
static void GlobeAddTxPlainPlainOwned(benchmark::Bench& bench) { AddTx(bench, "plain", "plain", true); }
static void GlobeAddTxPlainBlindNotOwned(benchmark::Bench& bench) { AddTx(bench, "plain", "blind", false); }
static void GlobeAddTxPlainBlindOwned(benchmark::Bench& bench) { AddTx(bench, "plain", "blind", true); }
// static void GlobeAddTxPlainAnonNotOwned(benchmark::Bench& bench) { AddTx(bench, "plain", "anon", false); }
// static void GlobeAddTxPlainAnonOwned(benchmark::Bench& bench) { AddTx(bench, "plain", "anon", true); }

static void GlobeAddTxBlindPlainNotOwned(benchmark::Bench& bench) { AddTx(bench, "blind", "plain", false); }
static void GlobeAddTxBlindPlainOwned(benchmark::Bench& bench) { AddTx(bench, "blind", "plain", true); }
static void GlobeAddTxBlindBlindNotOwned(benchmark::Bench& bench) { AddTx(bench, "blind", "blind", false); }
static void GlobeAddTxBlindBlindOwned(benchmark::Bench& bench) { AddTx(bench, "blind", "blind", true); }
static void GlobeAddTxBlindAnonNotOwned(benchmark::Bench& bench) { AddTx(bench, "blind", "anon", false); }
static void GlobeAddTxBlindAnonOwned(benchmark::Bench& bench) { AddTx(bench, "blind", "anon", true); }

static void GlobeAddTxAnonPlainNotOwned(benchmark::Bench& bench) { AddTx(bench, "anon", "plain", false); }
static void GlobeAddTxAnonPlainOwned(benchmark::Bench& bench) { AddTx(bench, "anon", "plain", true); }
static void GlobeAddTxAnonBlindNotOwned(benchmark::Bench& bench) { AddTx(bench, "anon", "blind", false); }
static void GlobeAddTxAnonBlindOwned(benchmark::Bench& bench) { AddTx(bench, "anon", "blind", true); }
static void GlobeAddTxAnonAnonNotOwned(benchmark::Bench& bench) { AddTx(bench, "anon", "anon", false); }
static void GlobeAddTxAnonAnonOwned(benchmark::Bench& bench) { AddTx(bench, "anon", "anon", true); }

BENCHMARK(GlobeAddTxPlainPlainNotOwned);
BENCHMARK(GlobeAddTxPlainPlainOwned);
BENCHMARK(GlobeAddTxPlainBlindNotOwned);
BENCHMARK(GlobeAddTxPlainBlindOwned);
// BENCHMARK(GlobeAddTxPlainAnonNotOwned);
// BENCHMARK(GlobeAddTxPlainAnonOwned);

BENCHMARK(GlobeAddTxBlindPlainNotOwned);
BENCHMARK(GlobeAddTxBlindPlainOwned);
BENCHMARK(GlobeAddTxBlindBlindNotOwned);
BENCHMARK(GlobeAddTxBlindBlindOwned);
BENCHMARK(GlobeAddTxBlindAnonNotOwned);
BENCHMARK(GlobeAddTxBlindAnonOwned);

BENCHMARK(GlobeAddTxAnonPlainNotOwned);
BENCHMARK(GlobeAddTxAnonPlainOwned);
BENCHMARK(GlobeAddTxAnonBlindNotOwned);
BENCHMARK(GlobeAddTxAnonBlindOwned);
BENCHMARK(GlobeAddTxAnonAnonNotOwned);
BENCHMARK(GlobeAddTxAnonAnonOwned);
