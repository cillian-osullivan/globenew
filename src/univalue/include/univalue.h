...
// Copyright 2015 Globe Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef GLOBE_UNIVALUE_INCLUDE_UNIVALUE_H
#define GLOBE_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // GLOBE_UNIVALUE_INCLUDE_UNIVALUE_H
