...
#ifndef GLOBE_PROTOCOL_H
#define GLOBE_PROTOCOL_H
...
/**
 * Globe protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Globe Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Globe Core nodes used to support this by default, without advertising this bit,
    ...
    // globe-development mailing list. Remember that service bits are just
