# Bootstrappable Globe Core Builds

This directory contains the files necessary to perform bootstrappable Globe
Core builds.
...
To build Globe Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Globe Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/globe-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/globe-core/guix.sigs).
