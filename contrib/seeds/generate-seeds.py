...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef GLOBE_CHAINPARAMSSEEDS_H\n')
    g.write('#define GLOBE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the globe network\n')
    ...
    g.write('#endif // GLOBE_CHAINPARAMSSEEDS_H\n')
