#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Globe Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of globe node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple globe ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple globe ports', file=sys.stderr)
