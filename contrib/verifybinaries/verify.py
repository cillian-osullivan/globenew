...
"""Script for verifying Globe Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
globecore.org and globe.org and compares them.
...
WORKINGDIR = "/tmp/globe_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://globecore.org"
HOST2 = "https://globe.org"
VERSIONPREFIX = "globe-core-"
...
def main(args):
    ...
    if not success:
        print("globe.org failed to provide signature file, "
              "but globecore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("globe.org and globecore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Globe Core binary release "
