...
"""Example logging Globe Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/globed
...
def main(globed_path):
    ...
    b = BPF(text=program, usdt_contexts=[globed_with_usdts])
