...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the globe repository."
  exit 1
fi
...
# See https://github.com/globe/globe/issues/16064
...
echo 'When compiling globed, run `./configure` in the following way:'
echo
