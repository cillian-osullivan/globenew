...
def spenders_taproot_active():
    ...
    # == Test case for https://github.com/globe/globe/issues/24765 ==
...
class TaprootTest(GlobeTestFramework):
    ...
    def test_spenders(self, node, spenders, input_counts):
        ...
        while left:
            ...
            tx.nVersion = random.choice([1, 2, random.randint(0x00, 0x9f)])  # Globe: avoid versions that would be seen as Globe txns
