...
class BackwardsCompatibilityTest(GlobeTestFramework):
    ...
    def run_test_btc(self):
        ...
        # RPC loadwallet failure causes globed to exit, in addition to the RPC
        ...
        if self.options.descriptors:
            ...
            node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of Globe Core")
        ...
        if self.is_bdb_compiled():
            ...
            # Copy the 0.16 wallet to the last Globe Core version and open it:
            shutil.copyfile(
                os.path.join(node_v16_wallets_dir, "wallets/u1_v16"),
                os.path.join(node_master_wallets_dir, "u1_v16")
            )
            load_res = node_master.loadwallet("u1_v16")
            # Make sure this wallet opens without warnings. See https://github.com/globe/globe/pull/19054
            ...
            # Copy the 0.17 wallet to the last Globe Core version and open it:
            ...
            # Copy the 0.19 wallet to the last Globe Core version and open it:
            shutil.copytree(
