...
Verify that a globed node can use an external signer command.
...
class RPCSignerTest(GlobeTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart globed with -signer=<cmd>',
