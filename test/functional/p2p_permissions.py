...
class P2PPermissionsTests(GlobeTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].globeconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].globeconf, 'w', encoding="utf8") as f:
            f.write(newText)
