...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/globe/globe/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(GlobeTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/globe/globe/blob/master/doc/tracing.md#tracepoint-validationblock_connected
