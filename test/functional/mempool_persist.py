...
By default, globed will dump mempool on shutdown and
...
class MempoolPersistTest(GlobeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent globed from writing mempool.dat to disk. Verify that `savemempool` fails")
