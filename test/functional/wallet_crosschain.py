...
class WalletCrossChain(GlobeTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].globeconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].globeconf, 'w', encoding='utf8') as conf:
