...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/globe/globe/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(GlobeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our globed node")
