...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GlobeTestFramework
    pass


class ExampleTest(GlobeTestFramework):
    # Each functional test is a subclass of the GlobeTestFramework class.
    ...
    def custom_method(self):
        ...
        GlobeTestFramework class so other tests can use it."""
