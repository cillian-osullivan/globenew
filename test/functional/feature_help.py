...
"""Verify that starting globe with -h works as expected."""

from test_framework.test_framework import GlobeTestFramework
from test_framework.util import assert_equal

class HelpTest(GlobeTestFramework):
    ...
    def run_test(self):
        self.log.info("Start globe with -h for help text")
        ...
        self.log.info("Start globe with -version for version information")
        ...
        self.log.info("Start globed with -fakearg to make sure it does not start")
