...
class TestShell:
    """Wrapper Class for GlobeTestFramework.

    The TestShell class extends the GlobeTestFramework
    ...
    class __TestShell(GlobeTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GlobeTestFramework child class.
            self.num_nodes = 1
