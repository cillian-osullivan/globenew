...
from .test_framework import GlobeTestFramework
...
class GlobeTestFramework(GlobeTestFramework):
    def start_node(self, i, *args, **kwargs):
        kwargs['btcmode'] = False
        return super().start_node(i, *args, **kwargs)

    def globe_wallet(self, node, *args):
            ...
            for i, node in enumerate(self.nodes):
                ...
                for a in ea:
                    if a.startswith('-wallet'):
                        self.globe_wallet(node, a, 'create')
