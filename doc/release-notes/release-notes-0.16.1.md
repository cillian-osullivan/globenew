Globe Core version 0.16.1 is now available from:

  <https://globecore.org/bin/globe-core-0.16.1/>
...
- #12843 `df38b13` Test starting globed with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure globed processes are cleaned up when tests end (sdaftuar)
