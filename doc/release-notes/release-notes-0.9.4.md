Globe Core version 0.9.4 is now available from:

  https://globe.org/bin/0.9.4/
...
this update is incompatible with the Globe system and could lead to consensus
forks.

Globe Core released binaries from https://globe.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~globe/+archive/ubuntu/globe
- A third-party or self-compiled Globe Core

upgrade to Globe Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
