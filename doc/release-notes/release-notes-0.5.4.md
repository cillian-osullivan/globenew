Globe version 0.5.4 is now available for download at:
http://sourceforge.net/projects/globe/files/Globe/globe-0.5.4/
...
http://gitorious.org/globe/globed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Globe-Qt notifications under Growl 1.3.
Increase required age of Globe-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGlobe properly when installing Globe-Qt over it. (Windows)
