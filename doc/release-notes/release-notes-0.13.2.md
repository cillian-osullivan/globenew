Globe Core version 0.13.2 is now available from:

  <https://globe.org/bin/globe-core-0.13.2/>
...
- #8908 `4a974b2` Update globe-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow globe-tx to create v2 transactions (btcdrak)
