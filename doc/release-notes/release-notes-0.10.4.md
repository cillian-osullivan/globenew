Globe Core version 0.10.4 is now available from:

  <https://globe.org/bin/globe-core-0.10.4/>
...
- #6953 `43c2789` Split globe-tx into its own package
- #6953 `dfe0d4d` Include globe-tx binary on Debian/Ubuntu
