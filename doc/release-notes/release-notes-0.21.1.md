...
Globe Core version 0.21.1 is now available from:

  <https://globecore.org/bin/globe-core-0.21.1/>
...
fungibility of all globes. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Globe Core's wallet is
...
FAQ](https://globecore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/globe/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/globe/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/globe/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Globe](https://globemagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-globe)
  - [What do Schnorr Signatures Mean for Globe?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-globe)
...
- Development history overview
  - [Taproot](https://globeops.org/en/topics/taproot/)
  - [Schnorr signatures](https://globeops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://globeops.org/en/topics/tapscript/)
  - [Soft fork activation](https://globeops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://globe.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/globe/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/globe/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to globe.conf documentation (jonatack)
