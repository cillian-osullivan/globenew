Globe Core version *0.15.2* is now available from:

  <https://globecore.org/bin/globe-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in globe-tx (TheBlueMatt)
