Globe Core version 0.16.0.1 is now available.
...
Globe Core 0.16 introduces generic support for Hardware Signing Devices to provide key-signing capabilities. 
...
In order to facilitate deterministic generation of stealth addresses between Globe Core and Signing Devices the method used to generate these addresses has been changed.
