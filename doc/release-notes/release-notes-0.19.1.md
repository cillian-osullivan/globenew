...
Globe Core version 0.19.1 is now available from:

  <https://globecore.org/bin/globe-core-0.19.1/>
...
From Globe Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Globe Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Globe Core does not yet change appearance when
...
- #17488 fix "globed already running" warnings on macOS (fanquake)
