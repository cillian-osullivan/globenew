Globe-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/globe/files/Globe/globe-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Globe
...
New/changed settings (command-line or globe.conf file)
--------------------------------------------------------
