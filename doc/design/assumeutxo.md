...
Assumeutxo is a feature that allows fast bootstrapping of a validating globed
...
- [Github issue](https://github.com/globe/globe/issues/15605)
- [draft PR](https://github.com/globe/globe/pull/15606)
...
considered active. This is the "traditional" mode of operation for globed.
...
**Failure consideration:** if globed unexpectedly halts after `m_stop_use` is set on
...
### Globed restarts sometime after snapshot validation has completed

When globed initializes again, what began as the snapshot chainstate is now
