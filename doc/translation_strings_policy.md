...
This document provides guidelines for internationalization of the Globe Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `globe_en.ts` remains unchanged.
