...
# Exclude --globe and --coverage to prevent timeouts
...
#export TEST_RUNNER_GLOBE="--globe"
export RUN_UNIT_TESTS_SEQUENTIAL="true"
export RUN_UNIT_TESTS="false"
export GOAL="install"
export DOWNLOAD_PREVIOUS_RELEASES="true"
export GLOBE_CONFIG="--enable-zmq --with-libs=no --with-gui=qt5 --enable-reduce-exports \
